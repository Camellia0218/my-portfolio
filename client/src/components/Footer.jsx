        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Kylie</h3>
              <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground/90 tracking-wide font-light">
                Visual Alchemist  <span className="text-[#002FA7] font-medium">Creative Developer</span> crafting
                high-impact digital narratives.
              </p>
            </motion.div>
          ...
          >
            <div>
              <p>© {currentYear} Kylie. All rights reserved.</p>
            </div>
